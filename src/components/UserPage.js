...
export default class MainPage extends Component {
  ...
  componentDidMount() {
    Promise.all([
      ...
      ([user, posts, plants, photos]) =>
        this.setState({ user, posts, plants, photos },() => this.findUsersPosts())
    )
  }
  ...
  render() {
    return (
      <div>
        <PlantCard userPosts={this.state.userPosts}/>
      </div>
    );
  }
